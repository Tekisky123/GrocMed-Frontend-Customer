...
export default function SettingsScreen() {
  const { deliveryPartner, logout } = useDeliveryPartner();
        ...
        <View style={styles.profileCard}>
          <View style={styles.profileAvatar}>
            <Text style={styles.profileAvatarText}>
              {deliveryPartner?.name?.charAt(0).toUpperCase() || 'P'}
            </Text>
          </View>
          <View style={styles.profileInfo}>
            <Text style={styles.profileName}>{deliveryPartner?.name || 'Partner'}</Text>
              ...
              <View style={[styles.settingItem, styles.settingItemLast]}>
                <View style={styles.settingItemLeft}>
                  ...
                  <View style={styles.settingLabelContainer}>
                    ...
                    <Text style={styles.settingValue}>{deliveryPartner?.name || 'Partner'}</Text>
                  </View>
                </View>
              ...
              <View style={[styles.settingItem, styles.settingItemLast]}>
                <View style={styles.settingItemLeft}>
                  ...
                  <View style={styles.settingLabelContainer}>
                    ...
                    <Text style={styles.settingValue}>{deliveryPartner?.email || 'partner@example.com'}</Text>
                  </View>
                </View>
                <Icon name="lock" size={18} color={Colors.textTertiary} library="material" />
              </View>
