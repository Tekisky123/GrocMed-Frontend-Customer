...
export default function AdminDashboard() {
  ...
  const recentActivities = [
    { id: '1', title: 'New order received', time: '2 mins ago', type: 'order', icon: 'shopping-cart', color: Colors.primary },
    { id: '2', title: 'Product stock updated', time: '15 mins ago', type: 'product', icon: 'inventory', color: Colors.warning },
    { id: '3', title: 'New user registered', time: '1 hour ago', type: 'user', icon: 'person-add', color: Colors.accent },
    { id: '4', title: 'Payment received', time: '2 hours ago', type: 'payment', icon: 'payment', color: Colors.success },
  ];

  const quickActions = [
    { id: '1', label: 'Add Product', icon: 'add-circle', color: Colors.primary },
    { id: '2', label: 'Manage Orders', icon: 'list-alt', color: Colors.accent },
    { id: '3', label: 'Settings', icon: 'settings', color: Colors.warning },
    { id: '4', label: 'Analytics', icon: 'analytics', color: Colors.success },
  ];
            ...
            <View style={styles.headerContent}>
              ...
              <View style={styles.headerText}>
                ...
                <View style={styles.roleContainer}>
                  ...
                  <Text style={styles.role}>{admin?.role?.toUpperCase() || 'ADMIN'}</Text>
                </View>
              </View>
            </View>
            <TouchableOpacity
